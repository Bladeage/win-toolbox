<#
    win-toolbox - Install or repair WinGet (asheroto winget-install)
    Version 1.0.0 | Generated by build.ps1 - do not edit, edit src/ instead.
    Source: https://github.com/Bladeage/win-toolbox
    Run:    irm https://raw.githubusercontent.com/Bladeage/win-toolbox/main/dist/winget.ps1 | iex
#>

& {
$SelfUrl = 'https://raw.githubusercontent.com/Bladeage/win-toolbox/main/dist/winget.ps1'
